...
import { onboardProps } from '../content/onboardProps';
import { Next, Back, TransitionToSide, ProgressBar } from '../components';
import Image from 'next/image';
import { renderComponent } from '../utils/ui';
...
const Onboard = () => {
    ...
    return (
        <Wrapper>
            ...
            <TransitionToSide array={pages} position={num}>
